\begin{figure}
	...
	\begin{subfigure}[b]{0.5\linewidth}
		\begin{tikzpicture}
			...
			\end{feynman}
			\node at (4,0) {\(=\frac{1}{v}\qty(m_{\rhn_{i}}\bm{\cK}_{R}^{\dagger}\bm{\cK}_{R} + m_{\rhn_{j}}\bm{\cK}_{R}^{T}\bm{\cK}^{*}_{R})_{ij}\)};
		\end{tikzpicture}
	\end{subfigure}
	\begin{subfigure}[b]{0.5\linewidth}
		\begin{tikzpicture}
			...
			\end{feynman}
			\node at (4,0) {\(=\frac{1}{v}\qty(m_{\rhn_{i}}\bm{\cK}_{R}^{T}\bm{\cK}^{*}_{L} + m_{\nu_{j}}\bm{\cK}_{R}^{\dagger}\bm{\cK}_{L})_{ij}\)};
		\end{tikzpicture}
	\end{subfigure}
	\label{fig:feynrules_hvv}
	\caption{Feynman rules containing a neutral Goldstone and two neutrinos. The Feynman rules for the
